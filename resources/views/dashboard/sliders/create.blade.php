       ...
       <div class="card-body grid gap-5">
          ...
          <div class="image-input size-16" data-image-input="true">
           <input accept=".png, .jpg, .jpeg" name="avatar" type="file">
            <input name="avatar_remove" type="hidden">
             ...
             <div class="image-input-placeholder rounded-full border-2 border-success image-input-empty:border-gray-300" style="background-image:url({{asset('DashboardAssets/assets/media/avatars/blank.png')}})">
              <div class="image-input-preview rounded-full" style="background-image:url({{asset('DashboardAssets/assets/media/avatars/300-2.png')}})">
              </div>
        ...
        <div class="w-full">
         <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
          ...
          <input class="input" name="title" type="text" value="Sample Title">
          </input>
         </div>
        </div>
        <div class="w-full">
         <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
          ...
          <input class="input" type="text" value="www.google.com" name="url">
          </input>
         </div>
        </div>
        <div class="w-full">
         <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
          ...
          <input class="input" placeholder="Click Now" type="text" name="url_title"/>
         </div>
        </div>
